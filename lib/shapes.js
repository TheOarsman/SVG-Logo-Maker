...
class Circle extends Shape {
  constructor(chooseShapeColor, chooseText, chooseTextColor) {
    super();
    this.setShapeColor(chooseShapeColor);
    this.setTextType(chooseText);
    this.setTextColor(chooseTextColor);
  }
